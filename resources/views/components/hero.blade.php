<section>
    <div class="w-full h-screen flex flex-col gap-4">
        ...
        <div class="w-full h-auto flex justify-center items-center flex-col">
            <div class="font-bold text-text text-6xl">Dapatkan website profesional</div>
            <div class="font-bold text-text text-6xl">untuk bisnis anda</div>
        </div>
        <div class="w-full h-auto px-[20rem] mt-2">
            <div class="text-text opacity-[70%] text-center text-md">Lorem ipsum dolor sit amet consectetur
        ...
        <div class="w-full h-auto flex justify-center items-center ">
            <div
                class="w-[13rem] h-[3rem] bg-dasar rounded-[27px] shadow-lg shadow-dasar flex justify-center items-center">
