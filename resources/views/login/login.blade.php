...
<div class="w-full h-screen flex">
    ...
    <div class="w-[55%] h-screen">
        <div class="w-full h-[17rem]  flex justify-center items-center flex-col">
            ...
            <div class="font-semibold opacity-60 text-text text-lg text-center  ">Login to your admin account with email and password.</div>
        </div>
        <div class="w-full h-[27.2rem] flex justify-center items-center">
            <form action="" method="post">
                <div class="w-[35rem] h-[23rem] flex flex-col">
                    <label for="" class="font-semibold text-text opacity-60 text-lg mb-2">Email Addres</label>
                    <i class="bi bi-envelope-open-fill absolute translate-y-[2.8rem] translate-x-[1rem] text-3xl text-dasar" id="emailOpen"></i>
                    <i class="bi bi-envelope-fill absolute translate-y-[2.8rem] translate-x-[1rem] text-3xl text-dasar invisible" id="emailTutup"></i>
                    <input type="email" class="w-full h-[3.5rem] rounded-[10px] pl-[3.5rem] border-1 border-slate-400 bg-slate-200 focus:outline-dasar" placeholder="Email Anda" id="inputEmail">
                    <label for="" class="font-semibold text-text opacity-60 text-lg mb-2 mt-4">Password</label>
                    <i class="bi bi-unlock-fill absolute translate-y-[10rem] translate-x-[1rem] text-3xl text-dasar" id="lockOpen"></i>
                    <i class="bi bi-lock-fill absolute translate-y-[10rem] translate-x-[1rem] text-3xl text-dasar invisible" id="lockTutup"></i>
                    <i class="bi bi-eye-slash  absolute translate-y-[10rem] translate-x-[32rem] text-3xl text-dasar hover:cursor-pointer" id="eyeTutup"></i>
                    <i class="bi bi-eye absolute translate-y-[10rem] translate-x-[32rem] text-3xl text-dasar invisible hover:cursor-pointer" id="eyeOpen"></i>
                    <input type="password" class="w-full h-[3.5rem] rounded-[10px] pl-[3.5rem] border-1 border-slate-400 bg-slate-200 focus:outline-dasar" placeholder="Password Anda" id="inputPassword">

                    <div class="w-full h-[10rem] flex justify-center items-center">
                        <div class="w-[15rem] h-[4.5rem] rounded-[10px] shadow-lg bg-gradient-to-r from-dasar to-third flex justify-center items-center hover:scale-[1.05] hover:cursor-pointer transition-all">
                            <div class="font-bold text-white text-xl">Login</div>
                        </div>
                    </div>
                </div>
            </form>
